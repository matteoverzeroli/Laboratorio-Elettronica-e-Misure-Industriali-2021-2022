...
Una volta realizzato il circuito, sono state misurate le tensioni ai nodi V\sub{B} e V\sub{O} da cui è possibile ricavare (tramite la legge di Ohm) le correnti di base e di emettitore. Inoltre, è possibile calcolare la transconduttanza come rapporto tra la corrente di collettore stazionaria e la tensione termica. Invece, la corrente di collettore si ricava come differenza tra la corrente di emettitore e corrente di base. 
